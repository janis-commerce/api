...
/** @typedef {import('../types/response').APIResponse} APIResponse */
/** @typedef {import('../types/response').ResponseCookieWithOptions} ResponseCookieWithOptions */
...
module.exports = class API {
	...
	/**
	 * @private
	 * @type {import('../types/request').APIRequest<RequestData>}
	 */
	...
	/**
	 * @returns {import('../helpers/request-parser').LowerCaseRequestMethod}
	 */
	get httpMethod() {
	...
	/**
	 * @param {import('../types/request').APIRequest<RequestData>} request
	 */
	set request(request) {
	...
	/**
	 * @returns {import('../types/request').APIRequest<RequestData>}
	 */
	get request() {
	...
	/**
	 * @returns {import('../helpers/request-parser').Cookies}
	 */
	get cookies() {
	 ...
	 * @param {string|ResponseCookieWithOptions} cookieValue
	 * @returns {this}
	 */
	...
	/**
	 * @param {Record<string, string|ResponseCookieWithOptions>} cookies
	 * @returns {this}
	 */
	setCookies(cookies) {
