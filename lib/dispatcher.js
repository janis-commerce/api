...
module.exports = class Dispatcher {
	...
	constructor(request) {
		...
		this.pristineData = request.data && Object.freeze(request.data);
	...
	async validate() {
		...
		try {
			...
			err.statusCode = err.statusCode || this.api.response.code || 400;
	...
	async process() {
		...
		try {
			...
			err.statusCode = err.statusCode || this.api.response.code || 500;
