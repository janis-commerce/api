...
/** @typedef {import('../types/request').LowerCaseHeaders} LowerCaseHeaders */
/** @typedef {import('../types/request').LowerCaseRequestMethod} LowerCaseRequestMethod */
/** @typedef {import('../types/request').Cookies} Cookies */
...
module.exports = class RequestParser {
	...
	static parse(event, logId) {
		...
		const headers = Object.entries(event.headers).reduce((/** @type {LowerCaseHeaders} */accum, [key, value]) => {
